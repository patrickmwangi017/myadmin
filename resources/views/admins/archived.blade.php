...
<a href="{{route('admins/home')}}" class="btn btn-info pull-right">Back to Home</a>
<br>
<br>
<div class="col-md-16">
...
<td>
<a href="{{route('feedback_unarchive', ['id'=>$row->id])}}" class="btn btn-primary"> Remove<br>from<br>archive </a>
</td>
