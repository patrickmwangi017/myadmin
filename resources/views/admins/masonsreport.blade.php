...
$w=array(20,40,40,20,20,20,40,20,18,15,15,15,15);
	...
	{ //width
		...
		$this->Cell(20,6,$eachResult["is_mason"],1);
		$this->Ln();
...
$header=array('mason ID','Name','Email', 'status');
//Data loading
//*** Load MySQL Data ***//
//db settings
$db_username = 'root';
...
$pdf->AddPage();
	...
	$result=mysqli_query($mysqli,"SELECT * FROM masons") or die ("Database query failed: $query" . mysql_error());
	
	$count = mysqli_num_rows($result);
	$pdf->Cell(0);
	$pdf->Write(5, ' All Total Masons : '.$count.'');
	$pdf->Ln();
