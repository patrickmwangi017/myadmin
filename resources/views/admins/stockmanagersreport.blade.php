...
$w=array(20,40,40,20,20,20,40,20,18,15,15,15,15);
	...
	{ //width
		...
		$this->Cell(20,6,$eachResult["is_stockmanager"],1);
		$this->Ln();
...
$header=array('Stockmanager ID','Name','Email', 'status');
//Data loading
//*** Load MySQL Data ***//
//db settings
$db_username = 'root';
...
$currMonth = date('m');
$strSQL = "Select* From stockmanagers";
...
$pdf->AddPage();
	...
	$result=mysqli_query($mysqli,"SELECT * FROM stockmanagers") or die ("Database query failed: $query" . mysql_error());
	
	$count = mysqli_num_rows($result);
	$pdf->Cell(0);
	$pdf->Write(5, ' All Total Stockmanagers : '.$count.'');
	$pdf->Ln();
