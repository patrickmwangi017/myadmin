...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           @else
                 <!-- logo for regular state and mobile devices -->
           <span class="logo-lg">Welcome Dear Accountant</b></span>
           @endif
...
<ul class="sidebar-menu" data-widget="tree">
                <!-- <li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('accountantprofile')}}"><i class="fa fa-clone"></i> Update Profile</a></li>
                            <!-- <li><a href="{{URL::to('/stock-manage')}}"><i class="fa fa-leaf"></i> Manage stock</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('accountants/home')}}"><i class="fa fa-clone"></i> All Payments</a></li>
                            <li><a href="{{URL::to('accountants/pending')}}"><i class="fa fa-money"></i> Pending Payments</a></li>
                            <li><a href="{{URL::to('accountants/approved')}}"><i class="fa fa-money"></i> Approved Payments</a></li>
                            <li><a href="{{URL::to('accountants/rejected')}}"><i class="fa fa-money"></i> Rejected Payments</a></li>
                            <li><a href="{{URL::to('accountants/refunded')}}"><i class="fa fa-money"></i> Refunded Payments</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{URL::to('accountants/paymentreport')}}">
                        <i class="fa fa-tint"></i>
                    ...
                    <li>
                        <a href="{{URL::to('accountantslogout')}}">
