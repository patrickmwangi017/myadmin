...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           @else
                 <!-- logo for regular state and mobile devices -->
           <span class="logo-lg">Welcome Dear Mason</b></span>
           @endif
...
<ul class="sidebar-menu" data-widget="tree">
                <!-- <li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('masonprofile')}}"><i class="fa fa-clone"></i> Update Profile</a></li>
                            <!-- <li><a href="{{URL::to('/stock-manage')}}"><i class="fa fa-leaf"></i> Manage stock</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-tint"></i>
                            <span> Service Deliveries</span>
                            <span class="pull-right-container">
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('masons/home')}}"><i class="fa fa-clone"></i> Allocated Bookings</a></li>
                            <li><a href="{{URL::to('masons/pending')}}"><i class="fa fa-money"></i> Pending Bookings</a></li>
                            <li><a href="{{URL::to('masons/delivered')}}"><i class="fa fa-money"></i> Bookings Delivered</a></li>
                            <li><a href="{{URL::to('masons/confirmed')}}"><i class="fa fa-money"></i> Confirmed Bookings</a></li>
                        </ul>
                    </li>
                    
                    <li>
                        <a href="{{URL::to('masonslogout')}}">
