...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           @else
                 <!-- logo for regular state and mobile devices -->
           <span class="logo-lg">Welcome Dear Order Manager</b></span>
           @endif
...
<ul class="sidebar-menu" data-widget="tree">
                <!-- <li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('ordermanagerprofile')}}"><i class="fa fa-clone"></i> Update Profile</a></li>
                            <!-- <li><a href="{{URL::to('/stock-manage')}}"><i class="fa fa-leaf"></i> Manage stock</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('ordermanager/home')}}"><i class="fa fa-clone"></i> All Orders</a></li>
                            <li><a href="{{URL::to('ordermanager/pendingorders')}}"><i class="fa fa-money"></i>Pending Orders</a></li>
                            <li><a href="{{URL::to('ordermanager/approvedorders')}}"><i class="fa fa-money"></i> Approved Orders</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('ordermanager/allbookings')}}"><i class="fa fa-clone"></i> All Bookings</a></li>
                            <li><a href="{{URL::to('ordermanager/pendingbookings')}}"><i class="fa fa-money"></i> Pending Bookings</a></li>
                            <li><a href="{{URL::to('ordermanager/approvedbookings')}}"><i class="fa fa-money"></i>Approved Bookings</a></li>
                            
                        </ul>
                    </li>
                    <li>
                        <a href="{{URL::to('ordermanager/ordersreport')}}">
                        <i class="fa fa-tint"></i>
                    ...
                    <li>
                        <a href="{{URL::to('ordermanager/bookingsreport')}}">
                        <i class="fa fa-tint"></i>
                        <span>Generate Bookings Report</span>
                        <span class="pull-right-container">
                        </span>
                    </a>
                    </li>
                    ...
                    <li>
                        <a href="{{URL::to('ordermanagerlogout')}}">
