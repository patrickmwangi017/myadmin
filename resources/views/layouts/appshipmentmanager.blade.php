...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           @else
                 <!-- logo for regular state and mobile devices -->
           <span class="logo-lg">Welcome Dear Shipment Manager</b></span>
           @endif
...
<ul class="sidebar-menu" data-widget="tree">
                <!-- <li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                        <li><a href="{{URL::to('shipmentmanager/home')}}"><i class="fa fa-clone"></i> All Orders</a></li>
                            <li><a href="{{URL::to('shipmentmanager/pendingorders')}}"><i class="fa fa-money"></i>Orders Pending Allocation</a></li>
                            <li><a href="{{URL::to('shipmentmanager/allocatedorders')}}"><i class="fa fa-money"></i> Allocated Orders</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                        <li><a href="{{URL::to('shipmentmanager/allbookings')}}"><i class="fa fa-clone"></i> All Bookings</a></li>
                            <li><a href="{{URL::to('shipmentmanager/pendingbookings')}}"><i class="fa fa-money"></i>Bookings Pending Allocation</a></li>
                            <li><a href="{{URL::to('shipmentmanager/allocatedbookings')}}"><i class="fa fa-money"></i> Allocated Bookings</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="{{URL::to('shipmentmanager/servicedeliveryreport')}}">
                        <i class="fa fa-tint"></i>
                        <span>Generate Service Delivery Report</span>
                        <span class="pull-right-container">
                        </span>
                    </a>
                    </li>
