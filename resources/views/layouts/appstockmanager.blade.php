...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
           ...
           @else
                 <!-- logo for regular state and mobile devices -->
           <span class="logo-lg">Welcome Dear Stock Manager</b></span>
           @endif
...
<ul class="sidebar-menu" data-widget="tree">
                <!-- <li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('stockmanagerprofile')}}"><i class="fa fa-clone"></i> Update Profile</a></li>
                            <!-- <li><a href="{{URL::to('/stock-manage')}}"><i class="fa fa-leaf"></i> Manage stock</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('stockmanager/home')}}"><i class="fa fa-clone"></i> All Products</a></li>
                            <li><a href="{{URL::to('accountants/approved')}}"><i class="fa fa-money"></i> Available Products</a></li>
                            <li><a href="{{URL::to('accountants/pending')}}"><i class="fa fa-money"></i>Archived Products</a></li>
                            
                        </ul>
                    </li>
                    
                    <li>
                        <a href="{{URL::to('stockmanagerlogout')}}">
