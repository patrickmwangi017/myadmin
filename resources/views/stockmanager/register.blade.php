    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Stock Manager Register</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('stockmanager.register') }}">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <p>Already have an account? <a href="{{ route('stockmanager.login')}}">Login instead </a></p>
                            </div>
                        </div>
                    </form>
                </div>
